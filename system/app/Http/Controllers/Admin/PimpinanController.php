...
class PimpinanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $pimpinan->save();
        return redirect('admin/struktur-organisasi')->with('success', 'Data Berhasil di Simpan');
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/struktur-organisasi')->with('error', 'Data Berhasil di Hapus');
    }
}
